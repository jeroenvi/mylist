<?php
    ...
    $string['choosecolumns']            = '<br /><br />Toon/verberg <br />kolommen:';
    ...
    $string['cfg_col_progress']         = 'Voortgang';
    
    $string['cfg_col_progress_help']        = 'De voortgangsbalk laat zien hoeveel van de vereiste cursusonderdelen je al hebt voltooid.';
    ...
    $string['noprogress']               = 'Het bijhouden van voortgang is voor deze cursus niet ingesteld';
